...
{              All rights reserved                      }
{                                                       }
{   PL version for Delphi Alexandria //ZS               }
{*******************************************************}
...
resourcestring
  ...
  SMsgDlgConfirm = 'PotwierdŸ';
  SMsgDlgYes = 'Tak';
  SMsgDlgNo = 'Nie';
  SMsgDlgOK = 'OK';
  SMsgDlgCancel = 'Anuluj';
  SMsgDlgHelp = 'Help';
...
resourcestring
  ...
  SEditPaste = 'Wklej';
  SEditDelete = 'Usuñ';
  SEditSelectAll = 'Zaznacz wszystko';
